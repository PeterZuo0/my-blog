...
export default function Testimonials() {
    return <section className="testimonial--section" id="testimonials">
            ...
            {data?.testimonial?.map((item,index)=>(
                <div key={index} className="testimonial--section--card">
                    ...
                    <div className="testimonial--section--card--author--detail">
                        ...
                        <div>
                            <p className="text-mid testimonial--author--name">{item.author_name}</p>
                            <p className="text-mid testimonial--author--designation">{item.author_designation}</p>
                        </div>
                    </div>
                </div>
            ))}
